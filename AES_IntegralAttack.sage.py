...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_256 = Integer(256); _sage_const_16 = Integer(16)# Status:
...
def checkBalanceProperty():
  ...
  for activeByteStr in activatedBytes:
    activeByte = int(activeByteStr, _sage_const_16 )
...
for preparedInput in preparedInputList:
  print(preparedInput)
  AES(rgf._hex_to_GF(preparedInput), key_state, _sage_const_3 )
