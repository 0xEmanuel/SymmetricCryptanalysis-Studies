...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_182 = Integer(182); _sage_const_241 = Integer(241); _sage_const_183 = Integer(183); _sage_const_68 = Integer(68); _sage_const_134 = Integer(134); _sage_const_65 = Integer(65); _sage_const_216 = Integer(216); _sage_const_47 = Integer(47); _sage_const_113 = Integer(113); _sage_const_115 = Integer(115); _sage_const_204 = Integer(204); _sage_const_82 = Integer(82); _sage_const_173 = Integer(173); _sage_const_239 = Integer(239); _sage_const_152 = Integer(152); _sage_const_219 = Integer(219); _sage_const_237 = Integer(237); _sage_const_197 = Integer(197); _sage_const_195 = Integer(195); _sage_const_255 = Integer(255); _sage_const_256 = Integer(256); _sage_const_11 = Integer(11); _sage_const_16 = Integer(16); _sage_const_59 = Integer(59); _sage_const_37 = Integer(37); _sage_const_122 = Integer(122); _sage_const_127 = Integer(127); _sage_const_168 = Integer(168); _sage_const_129 = Integer(129); _sage_const_91 = Integer(91); _sage_const_165 = Integer(165); _sage_const_161 = Integer(161)# Status:
...
def calcStateXorSum(stateList): ## TODO: Faster if I XOR only the active/relevant byte
...
def IntegralAttack(keyByteGuessList, plainTextTemplate):
  ...
  #####
  for activeBytePosition in range(_sage_const_0 ,_sage_const_16 ): #iterate over all 16 key bytes. Each iteration we handle one active byte / key byte at fixed position
...
def createPairsByBytePosition(index, template): 
  ...
  for j in range(_sage_const_0 ,_sage_const_256 ): #create random byte      
    ...
    cipherText = rgf._GF_to_hex( AES(rgf._hex_to_GF(preparedPlaintext), key_state_G, _sage_const_3 ) )
...
for i in range(_sage_const_0 ,_sage_const_16 ):
  guesses.append(range(_sage_const_0 ,_sage_const_255 ))
...
allKeyByteCandidates = [[_sage_const_152 , _sage_const_197 , _sage_const_239 ], [_sage_const_68 ], [_sage_const_165 , _sage_const_183 , _sage_const_204 ], [_sage_const_65 ], [_sage_const_161 , _sage_const_168 , _sage_const_216 ], [_sage_const_82 ], [_sage_const_91 , _sage_const_195 , _sage_const_237 ], [_sage_const_127 ], [_sage_const_47 , _sage_const_182 , _sage_const_241 ], [_sage_const_113 , _sage_const_134 ], [_sage_const_37 , _sage_const_115 ], [_sage_const_59 , _sage_const_122 ], [_sage_const_219 ], [_sage_const_11 ], [_sage_const_129 , _sage_const_173 ], [_sage_const_0 ]]
...
keyBytes = [[_sage_const_239 ], [_sage_const_68 ], [_sage_const_165 ], [_sage_const_65 ], [_sage_const_168 ], [_sage_const_82 ], [_sage_const_91 ], [_sage_const_127 ], [_sage_const_182 ], [_sage_const_113 ], [_sage_const_37 ], [_sage_const_59 ], [_sage_const_219 ], [_sage_const_11 ], [_sage_const_173 ], [_sage_const_0 ]]
