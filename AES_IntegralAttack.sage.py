...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_256 = Integer(256); _sage_const_16 = Integer(16); _sage_const_32 = Integer(32)# Status:
...
def StateSum(stateList):
  ...
  print("stateSum: ", str(hex(stateSum)).zfill(_sage_const_32 ) )
  return stateSum 
...
def createCpaPairs(): 
  ...
  #2,3
  #4,5
  for i in range(_sage_const_4 ,_sage_const_5 ,_sage_const_2 ): #len(template) iterate over the bytes in the template  
    for j in range(_sage_const_0 ,_sage_const_256 ): #create random byte      
      ...
      preparedPlaintext = template[_sage_const_0 :i] + activeByte + template[i+_sage_const_2 :len(template)] 
      cipherText = rgf._GF_to_hex( AES(rgf._hex_to_GF(preparedPlaintext), key_state, _sage_const_3 , true) )
